...
// Assuming EADashedBoardScreen is defined elsewhere in your project
import 'package:event_prokit/screens/EADashedBoardScreen.dart'; // Adjust the import path as needed
...
class _SetProfileState extends State<SetProfile> {
  ...
  Future<void> _updateProfile() async {
    ...
    try {
      ...
      // Navigate to EADashedBoardScreen after a short delay to allow the user to see the success message
